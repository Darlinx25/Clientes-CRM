...
export function DateFormatProvider({ children }: { children: ReactNode }) {
  ...
  const getBirthdayFormatHint = useCallback(() => {
    switch (dateFormat) {
      case "eu":
        return "DD/MM/YYYY (año opcional, ej. 30/04/1990 o 30/04)";
      case "iso":
        return "YYYY-MM-DD (año opcional, ej. 1990-04-30 o --04-30 o 04-30)";
      default: // us
        return "MM/DD/YYYY (año opcional, ej. 04/30/1990 o 04/30)";
    }
  }, [dateFormat]);
