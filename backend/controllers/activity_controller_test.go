...
func setupRouter() (*gorm.DB, *gin.Engine) {
	...
	db.AutoMigrate(&models.Contact{}, &models.Activity{}, &models.Note{}, models.Relationship{}, models.Reminder{}, models.User{}, models.Webhook{}, models.WebhookDelivery{}, models.Company{})
